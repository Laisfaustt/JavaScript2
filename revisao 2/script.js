...
botao.addEventListener("click", () => {
    mensagem.innerText = "Ola " + input.value;
})
...
converter.addEventListener("click", () => {
    ...
    let dobro = numero * 2
    resultado.innerText = "O dobro de " + dobro;
})
...
let maior = Math.max(5, 10, 15, 8, 2, 30)
let menor = Math.min(5, 10, 15, 8, 2, 30)
console.log("Maior número:", maior)
console.log("Menor número:", menor)

let raiz = Math.sqrt(25)
let absolutp = Math.abs(-10)
console.log(raiz)
